...
export default function About({ authors, siteconfig }) {
  return (
    ...
    <div className="container px-6 py-10 mx-auto">
        ...
        Our team is a group of highly skilled professionals with diverse backgrounds and experiences. We are passionate about working together to create innovative solutions and deliver exceptional results for our clients. With a strong focus on collaboration and continuous learning, we strive to exceed expectations and drive success.
        </p>
        ...
        <div className="flex flex-row-reverse justify-center items-center gap-4">
           {
            ...
            authors.map((author,idx)=>(
              <div key={idx} className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
              ...
              />
              <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">{author.name}</h1>
