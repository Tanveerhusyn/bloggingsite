...
export default function Footer(props) {
  return (
    <footer className="bg-white dark:bg-gray-900 mt-20 border-y-2">
    <div className="container p-6 mx-auto">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Politics</a>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Technology</a>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Entertainment</a>
                    </div>

                    <div>
                        <h3 className="text-gray-700 uppercase dark:text-white">Contact</h3>
                    
                        <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">tanveerhusyn465@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Scribble Wire 2023 - All rights reserved</p>
        </div>
    </div>
</footer>
  )
